...
@SecurityDomain("DvcmeCredencialesDomain")
 @RolesAllowed({
     "ADMINISTRADOR",
     "ADMINISTRADOR_CONVENIO",
     "USUARIO_INTERNO_VRA_CONVENIO",
     "USUARIO_INTERNO_VRE_CONVENIO",
     "USUARIO_INTERNO_VRIIP_CONVENIO",
     "USUARIO_INTERNO_OTL_CONVENIO",
     "USUARIO_INTERNO_DJ_CONVENIO",
     "SECRETARIA_GENERAL_CONVENIO",
     "USUARIO_INTERNO_RECTORIA_CONVENIO",
     "USUARIO_INTERNO_CREACION_CONVENIO",
     "USUARIO_INTERNO_SEGUIMIENTO_CONVENIO",
     "USUARIO_EXTERNO_CONVENIO",
     "USUARIO_ADMINISTRADOR_SEGUIMIENTO",
     "USUARIO_INTERNO_SEGUIMIENTO",
     "USUARIO_EXTERNO_SEGUIMIENTO"
 })
